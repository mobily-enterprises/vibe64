...
function aiStudioStatusCode(response, { missingStatus = 404 } = {}) {
  ...
  if (code.startsWith("ai_studio_invalid")) {
    return 400;
  }
...
function registerRoutes(
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).listAiStudioSessions(request.query || {});
  ...
  router.register(
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).createAiStudioSession();
      reply.code(aiStudioStatusCode(response)).send(response);
    }
  );
  ...
  router.register(
    "GET",
    `${routeBase}/ai-studio/sessions/:sessionId`,
    {
      auth: "public",
      surface: normalizedRouteSurface,
      meta: {
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).inspectAiStudioSession(request.params.sessionId);
      reply.code(aiStudioStatusCode(response)).send(response);
    }
  );
  ...
  router.register(
    "POST",
    `${routeBase}/ai-studio/sessions/:sessionId/actions/:actionId`,
    {
      auth: "public",
      surface: normalizedRouteSurface,
      meta: {
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).runAiStudioSessionAction(
        request.params.sessionId,
        request.params.actionId,
        requestBodyObject(request)
      );
      reply.code(aiStudioStatusCode(response, { missingStatus: 404 })).send(response);
    }
  );

  router.register(
    "POST",
    `${routeBase}/ai-studio/sessions/:sessionId/advance`,
    {
      auth: "public",
      surface: normalizedRouteSurface,
      meta: {
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).advanceAiStudioSession(request.params.sessionId);
      reply.code(aiStudioStatusCode(response, { missingStatus: 404 })).send(response);
    }
  );
  ...
  router.register(
    "POST",
    `${routeBase}/ai-studio/sessions/:sessionId/abandon`,
    {
      auth: "public",
      surface: normalizedRouteSurface,
      meta: {
    ...
    async function (request, reply) {
      ...
      const response = await getCurrentAppService(app).abandonAiStudioSession(request.params.sessionId);
      reply.code(aiStudioStatusCode(response, { missingStatus: 404 })).send(response);
    }
  );
