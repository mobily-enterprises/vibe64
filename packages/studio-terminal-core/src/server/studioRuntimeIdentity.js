...
const STUDIO_TOOL_HOME_ENV = "VIBE64_STUDIO_TOOL_HOME";
...
const STUDIO_RUNTIME_PACK_ROOT_PATH = "/opt/vibe64/runtime-packs";
const STUDIO_MANAGED_OPERATOR_CLI_BIN_PATH = `${STUDIO_RUNTIME_PACK_ROOT_PATH}/managed-bin`;
const STUDIO_MANAGED_CLAUDE_COMMAND = `${STUDIO_MANAGED_OPERATOR_CLI_BIN_PATH}/claude`;
const STUDIO_MANAGED_CODEX_COMMAND = `${STUDIO_MANAGED_OPERATOR_CLI_BIN_PATH}/codex`;
...
export {
  ...
  STUDIO_MANAGED_OPERATOR_CLI_BIN_PATH,
  STUDIO_RUNTIME_PACK_ROOT_PATH,
