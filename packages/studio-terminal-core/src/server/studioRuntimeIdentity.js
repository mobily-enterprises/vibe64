...
const STUDIO_GITHUB_PROVIDER_HOME_PATH = `${STUDIO_TOOL_HOME_PATH}/.vibe64-github-provider`;
const STUDIO_GITHUB_PROVIDER_GH_CONFIG_DIR = `${STUDIO_GITHUB_PROVIDER_HOME_PATH}/.config/gh`;
const STUDIO_GITHUB_PROVIDER_GIT_CONFIG_GLOBAL = `${STUDIO_GITHUB_PROVIDER_HOME_PATH}/.gitconfig`;
