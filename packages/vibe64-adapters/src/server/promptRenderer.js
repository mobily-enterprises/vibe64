...
function promptSessionBriefing(contextInput = {}) {
  ...
  return [
    ...
    "Vibe64 control files include `.vibe64/project_type`, `.vibe64/config/*`, `.vibe64/scripts`, `.vibe64/prompts`, `.vibe64/project-knowledge`, and project `runtime-config/*`.",
    "Do not delete, move, or overwrite those files to clean a diff or silence Git/status/tooling. Inspect and report them when relevant. Edit them only when the user explicitly asks for that specific Vibe64 config change or the current Vibe64 workflow prompt explicitly instructs you to update that artifact.",
    "",
    "Code index policy:",
    codeIndexPolicy,
    "",
