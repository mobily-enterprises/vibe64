...
function sessionDriverOutput(input) {
  ...
  const lines = [
    ...
    ...(session.managedGit ? [
      ...
      "When linking an issue in this project's repository, run `vibe64-helper github issue-link <number>` and use its returned Vibe64 path as the primary Markdown link. You may include the GitHub URL as a secondary link. Do not guess the project slug or host; issues in other repositories keep their GitHub links.",
