...
<template>
  <v-menu v-if="enabled && available" location="top">
    <template #activator="{ props: menuProps }">
      <v-btn v-bind="menuProps" class="codex-plan-usage" size="small" variant="text" :title="details" :aria-label="`Weekly Codex allowance remaining: ${summary}`">
        {{ summary }}
      </v-btn>
    </template>
