...
const OPENCODE_PROVIDER_AUTH_ENDPOINT = `${ACCOUNTS_ENDPOINT}/opencode/providers/auth`;
const OPENCODE_PROVIDER_OAUTH_ENDPOINT = `${ACCOUNTS_ENDPOINT}/opencode/providers/oauth`;
...
function projectSelectionQueryKey(surfaceId, ownershipFilter) {
  return ["vibe64", surfaceId, ownershipFilter, "projects"];
}
